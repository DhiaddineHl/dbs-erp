...
export const FACONNIERS: FaconnierRow[] = [
...
export const FOURNITURES: FournitureRow[] = [
...
export const CAPACITE_CHAINES: CapaciteChaineRow[] = [
...
export const COSTING: CostingRow[] = [
...
export const MAGASIN: MagasinRow[] = [
